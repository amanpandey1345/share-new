...
import ComputerLion from '../Bet-Images-Computer/ComputerLion.jpg';
import MobileLion from '../Bet-Images-Mobile/MobileLion.jpg';
...
function Lion_Bet ({history}) {
  ...
  useEffect(() => {
    ...
    <>
    {loading ? <Loader/> : (<>
      <MetaData title={`Loin Bet`} />
        <div className={styles.bet_background}>
        
        <div className={styles.bet_back}>
            <div  className={styles.bet_image}>
            <img src={ComputerLion} alt="Lion" className={styles.Computer}/>
               <img src={MobileLion} alt="Lion" className={styles.Mobile}/>
            </div>
